...
`ic()` will return the reuslt of evaluating its input but will not print anything.
...
* `ic.format()` and enable / disable (see [here](https://github.com/gruns/icecream#miscellaneous)).
