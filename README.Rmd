...
These two options control how the result of evaluation of an expression is printed. `icecream.peeking.function` indicates the function that summarizes the object. Default value is `str`. `icecream.max.lines` determines maximum number of lines that the peek of an obejct occupies; defaults to 1. 
...
Note that if `icecream.max.lines` is greater than 1 and summary of an object is longer than 1, the alert occupies one line more due to the header.
